...
export function ProblemStatement() {
  return (
    <>
      <Box as="section" px={{ base: "0", lg: "20" }} mb={{ base: "0%", lg: "5%" }}>
        <Box
        ...
        >
          ...
          >
            <Stack flex="1" maxW={{ base: "3xl", lg: "3xl" }} mx="auto" >
              ...
              >
                <Heading fontWeight="600" color="dark.200" fontSize={{ base: "xl", md: "3xl" }}>
                  Let&apos;s face it...{" "}
                </Heading>
              ...
              <Box pt={5} px={5}>
                <Text fontSize={{ base: "md", sm: "md", lg: "xl" }} fontWeight="500">
                ...
                <Text fontSize={{ base: "xl", md: "2xl" }} fontWeight="bold" bgClip="text" bgGradient="linear(to-tr, mintro.200, mintro.400)">
                  Meet People Better.
                </Text>
              </Box>
            </Stack>
            ...
            >
              <Parallax>
                ...
                <Box w="100%">
                  <Heading mx="auto" maxW={{base: "unset", lg: "2xl" }} fontWeight="600" fontSize={{ base: "2xl", md: "3xl" }} color="dark.500">

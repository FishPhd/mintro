import { MINTRO_LOGO_URL } from "../../constants";
            ...
            >
              ...
              <tr>
                <td style="text-align: center">
                  <a href="https://${process.env.CORS_ORIGIN}" title="logo" target="_blank">
                    <img width="60" src="${MINTRO_LOGO_URL}" title="logo" alt="logo">
                  </a>
                </td>
              </tr>
              <tr>
